...
cmsRun  $theCfg inputFiles="$mcSignalEle" outputFile="MCSignalEle_52X_ntuples.root" makeHZG=1 reportEvery=100 >& MCSignalEle_ntuples.log &

cmsRun  $theCfg inputFiles="$mcBkgEle" outputFile="MCBkgEle_52X_ntuples.root" makeHZG=1 reportEvery=100 >& MCBkgEle_ntuples.log &

cmsRun  $theCfg inputFiles="$dataElectron" outputFile="DataElectron_52X_ntuples.root" makeHZG=1 reportEvery=100 >& DataElectron_ntuples.log &

cmsRun  $theCfg inputFiles="$dataMuon" outputFile="DataMuon_52X_ntuples.root" makeHZG=1 reportEvery=100 >& DataMuon_ntuples.log &
