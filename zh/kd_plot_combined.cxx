void kd_plot_combined()  {
  TFile *comb = TFile::Open("results/2012-10-24-8TeV-v1-Higgs/kd_plots/root_files/output-COMB.root"); 
  ...
  l1->SetFillColor(0);
  l1->Draw();
  c1->SaveAs("results/2012-10-24-8TeV-v1-Higgs/kd_plots/kd1_COMB.png");  
  ...
  l2->SetFillColor(0);
  l2->Draw();
  c2->SaveAs("results/2012-10-24-8TeV-v1-Higgs/kd_plots/kd2_COMB.png");
