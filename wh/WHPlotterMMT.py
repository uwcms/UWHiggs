...
if __name__ == "__main__":
    ...
    if not options.no_shapes:
        ...
        for prefix in prefixes:
            ...
            plotter.write_shapes(prefix+'m2_t_Mass#LT', rebin_slim, shape_dir, qcd_fraction=0.5, project=[0, 650], project_axis='X')
            shape_dir = shape_file.mkdir('mmt_w')
            plotter.write_shapes(prefix+'m2_t_Mass#LT', rebin_slim, shape_dir, qcd_fraction=0.0, project=[0, 650], project_axis='X')
