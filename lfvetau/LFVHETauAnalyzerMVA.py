        ...
        if bool(isTauTight) == False:               
            if f.startswith('os') or  f.startswith('ss')  :
                ...
                for n, l in enumerate(looseList) :
                    ...
                    histos[folder+'/tPt'].Fill(row.tPt, row.EmbPtWeight*frweight)
                    histos[folder+'/tEta'].Fill(row.tEta, row.EmbPtWeight*frweight)
                    histos[folder+'/tPhi'].Fill(row.tPhi, row.EmbPtWeight*frweight) 
                    histos[folder+'/ePt'].Fill(row.ePt, row.EmbPtWeight*frweight)
                    histos[folder+'/eEta'].Fill(row.eEta, row.EmbPtWeight*frweight)
                    histos[folder+'/ePhi'].Fill(row.ePhi, row.EmbPtWeight*frweight)
                    histos[folder+'/et_DeltaPhi'].Fill(deltaPhi(row.ePhi, row.tPhi), row.EmbPtWeight*frweight)
                    histos[folder+'/et_DeltaR'].Fill(row.e_t_DR, row.EmbPtWeight*frweight)
                    histos[folder+'/h_collmass_vs_dPhi_pfmet'].Fill(deltaPhi(row.tPhi, row.type1_pfMetPhi), collmass(row, row.type1_pfMetEt, row.type1_pfMetPhi), row.EmbPtWeight*frweight)
                    histos[folder+'/h_collmass_vs_dPhi_mvamet'].Fill(deltaPhi(row.tPhi, row.mva_metPhi), collmass(row, row.mva_metEt, row.mva_metPhi), row.EmbPtWeight*frweight)
                    histos[folder+'/h_collmassSpread_vs_dPhi_pfmet'].Fill(deltaPhi(row.tPhi, row.type1_pfMetPhi), collmass(row, row.type1_pfMetEt, row.type1_pfMetPhi)-125.0, row.EmbPtWeight*frweight)
                    histos[folder+'/h_collmassSpread_vs_dPhi_mvamet'].Fill(deltaPhi(row.tPhi, row.mva_metPhi), collmass(row, row.mva_metEt, row.mva_metPhi)-125.0, row.EmbPtWeight*frweight)
                    if deltaPhi(row.tPhi, row.pfMetPhi) > 1.57 :  
                        histos[folder+'/h_collmass_highPhi_pfmet'].Fill(collmass(row, row.type1_pfMetEt, row.type1_pfMetPhi), row.EmbPtWeight*frweight)
                        histos[folder+'/h_collmassSpread_highPhi_pfmet'].Fill(collmass(row, row.type1_pfMetEt, row.type1_pfMetPhi)-125.0, row.EmbPtWeight*frweight)
                    if deltaPhi(row.tPhi, row.pfMetPhi) < 1.57 :  
                        histos[folder+'/h_collmass_lowPhi_pfmet'].Fill(collmass(row, row.type1_pfMetEt, row.type1_pfMetPhi), row.EmbPtWeight*frweight)
                        histos[folder+'/h_collmassSpread_lowPhi_pfmet'].Fill(collmass(row, row.type1_pfMetEt, row.type1_pfMetPhi)-125.0, row.EmbPtWeight*frweight)
                    if deltaPhi(row.tPhi, row.mva_metPhi) > 1.57 :  
                        histos[folder+'/h_collmass_highPhi_mvamet'].Fill(collmass(row, row.mva_metEt, row.mva_metPhi), row.EmbPtWeight*frweight)
                        histos[folder+'/h_collmassSpread_highPhi_mvamet'].Fill(collmass(row, row.mva_metEt, row.mva_metPhi)-125.0, row.EmbPtWeight*frweight)
                    if deltaPhi(row.tPhi, row.mva_metPhi) < 1.57 :  
                        histos[folder+'/h_collmass_lowPhi_mvamet'].Fill(collmass(row, row.mva_metEt, row.mva_metPhi), row.EmbPtWeight*frweight)
                        histos[folder+'/h_collmassSpread_lowPhi_mvamet'].Fill(collmass(row, row.mva_metEt, row.mva_metPhi)-125.0, row.EmbPtWeight*frweight)

                    histos[folder+'/h_collmassSpread_pfmet'].Fill(collmass(row, row.type1_pfMetEt, row.type1_pfMetPhi)-125.0, row.EmbPtWeight*frweight)
                    histos[folder+'/h_collmassSpread_mvamet'].Fill(collmass(row, row.mva_metEt, row.mva_metPhi)-125.0, row.EmbPtWeight*frweight)
                    histos[folder+'/h_collmass_pfmet'].Fill(collmass(row, row.pfMetEt, row.pfMetPhi), row.EmbPtWeight*frweight)
                    histos[folder+'/h_collmass_mvamet'].Fill(collmass(row, row.mva_metEt, row.mva_metPhi), row.EmbPtWeight*frweight)
                    histos[folder+'/h_collmass_pfmet_Ty1'].Fill(collmass(row, row.type1_pfMetEt, row.type1_pfMetPhi), row.EmbPtWeight*frweight)

                    #histos[folder+'/h_collmass_pfmet_jes'].Fill(collmass(row, row.pfMet_jes_Et, row.pfMet_jes_Phi), row.EmbPtWeight*frweight)
                    #histos[folder+'/h_collmass_pfmet_mes'].Fill(collmass(row, row.pfMet_mes_Et, row.pfMet_mes_Phi), row.EmbPtWeight*frweight)
                    #histos[folder+'/h_collmass_pfmet_tes'].Fill(collmass(row, row.pfMet_tes_Et, row.pfMet_tes_Phi), row.EmbPtWeight*frweight)
                    #histos[folder+'/h_collmass_pfmet_ees'].Fill(collmass(row, row.pfMet_ees_Et, row.pfMet_ees_Phi), row.EmbPtWeight*frweight)
                    #histos[folder+'/h_collmass_pfmet_ues'].Fill(collmass(row, row.pfMet_ues_Et, row.pfMet_ues_Phi), row.EmbPtWeight*frweight)
                    
                    
                    histos[folder+'/h_vismass'].Fill(row.e_t_Mass, row.EmbPtWeight*frweight)
                    histos[folder+'/type1_pfMetEt_vs_dPhi'].Fill(deltaPhi(row.tPhi, row.type1_pfMetPhi), row.type1_pfMetEt, row.EmbPtWeight*frweight)
                    histos[folder+'/mvaMetEt_vs_dPhi'].Fill(deltaPhi(row.tPhi, row.mva_metPhi), row.mva_metEt, row.EmbPtWeight*frweight)
                        
                    histos[folder+'/ePFMET_DeltaPhi'].Fill(deltaPhi(row.ePhi, row.pfMetPhi), row.EmbPtWeight*frweight)
                    histos[folder+'/ePFMET_DeltaPhi_Ty1'].Fill(deltaPhi(row.ePhi, row.type1_pfMetPhi), row.EmbPtWeight*frweight)
                    histos[folder+'/eMVAMET_DeltaPhi'].Fill(deltaPhi(row.ePhi, row.mva_metPhi), row.EmbPtWeight*frweight)
                    histos[folder+'/ePFMET_Mt'].Fill(row.eMtToPFMET, row.EmbPtWeight*frweight)
                    histos[folder+'/ePFMET_Mt_Ty1'].Fill(row.eMtToPfMet_Ty1, row.EmbPtWeight*frweight)
                    histos[folder+'/eMVAMET_Mt'].Fill(row.eMtToMVAMET, row.EmbPtWeight*frweight)
                    ##histos[folder+'/ePFMET_Mt_Ty1_ues_minus'].Fill(row.eMtToPfMet_Ty1_ues_minus, row.EmbPtWeight*frweight)
                    ##histos[folder+'/ePFMET_Mt_Ty1_ues_plus'].Fill(row.eMtToPfMet_Ty1_ues_plus, row.EmbPtWeight*frweight)
                    #histos[folder+'/ePFMET_Mt_jes_minus'].Fill(row.eMtToPfMet_jes_minus, row.EmbPtWeight*frweight)
                    #histos[folder+'/ePFMET_Mt_jes_plus'].Fill(row.eMtToPfMet_jes_plus, row.EmbPtWeight*frweight)
                    #histos[folder+'/ePFMET_Mt_jes'].Fill(row.eMtToPfMet_jes, row.EmbPtWeight*frweight)
                    #histos[folder+'/ePFMET_Mt_mes_minus'].Fill(row.eMtToPfMet_mes_minus, row.EmbPtWeight*frweight)
                    #histos[folder+'/ePFMET_Mt_mes_plus'].Fill(row.eMtToPfMet_mes_plus, row.EmbPtWeight*frweight)
                    #histos[folder+'/ePFMET_Mt_mes'].Fill(row.eMtToPfMet_mes, row.EmbPtWeight*frweight)
                    #histos[folder+'/ePFMET_Mt_ees_minus'].Fill(row.eMtToPfMet_ees_minus, row.EmbPtWeight*frweight)
                    #histos[folder+'/ePFMET_Mt_ees_plus'].Fill(row.eMtToPfMet_ees_plus, row.EmbPtWeight*frweight)
                    #histos[folder+'/ePFMET_Mt_ees'].Fill(row.eMtToPfMet_ees, row.EmbPtWeight*frweight)
                    #histos[folder+'/ePFMET_Mt_tes_minus'].Fill(row.eMtToPfMet_tes_minus, row.EmbPtWeight*frweight)
                    #histos[folder+'/ePFMET_Mt_tes_plus'].Fill(row.eMtToPfMet_tes_plus, row.EmbPtWeight*frweight)
                    #histos[folder+'/ePFMET_Mt_tes'].Fill(row.eMtToPfMet_tes, row.EmbPtWeight*frweight)
                    #histos[folder+'/ePFMET_Mt_ues_minus'].Fill(row.eMtToPfMet_ues_minus, row.EmbPtWeight*frweight)
                    #histos[folder+'/ePFMET_Mt_ues_plus'].Fill(row.eMtToPfMet_ues_plus, row.EmbPtWeight*frweight)
                    #histos[folder+'/ePFMET_Mt_ues'].Fill(row.eMtToPfMet_ues, row.EmbPtWeight*frweight)

                    
                        
                    histos[folder+'/tPFMET_DeltaPhi'].Fill(deltaPhi(row.tPhi, row.pfMetPhi), row.EmbPtWeight*frweight)
                    histos[folder+'/tPFMET_DeltaPhi_Ty1'].Fill(deltaPhi(row.tPhi, row.type1_pfMetPhi), row.EmbPtWeight*frweight)
                    histos[folder+'/tMVAMET_DeltaPhi'].Fill(deltaPhi(row.tPhi, row.mva_metPhi), row.EmbPtWeight*frweight)
                    histos[folder+'/tPFMET_Mt'].Fill(row.tMtToPFMET, row.EmbPtWeight*frweight)
                    histos[folder+'/tMVAMET_Mt'].Fill(row.tMtToMVAMET, row.EmbPtWeight*frweight)
                    #histos[folder+'/tPFMET_Mt_jes'].Fill(row.tMtToPfMet_jes, row.EmbPtWeight*frweight)
                    #histos[folder+'/tPFMET_Mt_mes'].Fill(row.tMtToPfMet_mes, row.EmbPtWeight*frweight)
                    #histos[folder+'/tPFMET_Mt_ees'].Fill(row.tMtToPfMet_ees, row.EmbPtWeight*frweight)
                    #histos[folder+'/tPFMET_Mt_tes'].Fill(row.tMtToPfMet_tes, row.EmbPtWeight*frweight)
                    #histos[folder+'/tPFMET_Mt_ues'].Fill(row.tMtToPfMet_ues, row.EmbPtWeight*frweight)
                    
                    histos[folder+'/jetN_20'].Fill(row.jetVeto20, row.EmbPtWeight*frweight) 
                    histos[folder+'/jetN_30'].Fill(row.jetVeto30, row.EmbPtWeight*frweight) 
            ...
            for n,d  in enumerate(pudir) :
                ...
                histos[folder+'/tPt'].Fill(row.tPt, row.EmbPtWeight*weight[n])
                histos[folder+'/tEta'].Fill(row.tEta, row.EmbPtWeight*weight[n])
                histos[folder+'/tPhi'].Fill(row.tPhi, row.EmbPtWeight*weight[n]) 
                histos[folder+'/ePt'].Fill(row.ePt, row.EmbPtWeight*weight[n])
                histos[folder+'/eEta'].Fill(row.eEta, row.EmbPtWeight*weight[n])
                histos[folder+'/ePhi'].Fill(row.ePhi, row.EmbPtWeight*weight[n])
                histos[folder+'/et_DeltaPhi'].Fill(deltaPhi(row.ePhi, row.tPhi), row.EmbPtWeight*weight[n])
                histos[folder+'/et_DeltaR'].Fill(row.e_t_DR, row.EmbPtWeight*weight[n])
                    
                histos[folder+'/h_collmass_vs_dPhi_pfmet'].Fill(deltaPhi(row.tPhi, row.type1_pfMetPhi), collmass(row, row.type1_pfMetEt, row.type1_pfMetPhi), row.EmbPtWeight*weight[n])
                histos[folder+'/h_collmass_vs_dPhi_mvamet'].Fill(deltaPhi(row.tPhi, row.mva_metPhi), collmass(row, row.mva_metEt, row.mva_metPhi), row.EmbPtWeight*weight[n])
                histos[folder+'/h_collmassSpread_vs_dPhi_pfmet'].Fill(deltaPhi(row.tPhi, row.type1_pfMetPhi), collmass(row, row.type1_pfMetEt, row.type1_pfMetPhi)-125.0, row.EmbPtWeight*weight[n])
                histos[folder+'/h_collmassSpread_vs_dPhi_mvamet'].Fill(deltaPhi(row.tPhi, row.mva_metPhi), collmass(row, row.mva_metEt, row.mva_metPhi)-125.0, row.EmbPtWeight*weight[n])
                if deltaPhi(row.tPhi, row.pfMetPhi) > 1.57 :  
                    histos[folder+'/h_collmass_highPhi_pfmet'].Fill(collmass(row, row.type1_pfMetEt, row.type1_pfMetPhi), row.EmbPtWeight*weight[n])
                    histos[folder+'/h_collmassSpread_highPhi_pfmet'].Fill(collmass(row, row.type1_pfMetEt, row.type1_pfMetPhi)-125.0, row.EmbPtWeight*weight[n])
                if deltaPhi(row.tPhi, row.pfMetPhi) < 1.57 :  
                    histos[folder+'/h_collmass_lowPhi_pfmet'].Fill(collmass(row, row.type1_pfMetEt, row.type1_pfMetPhi), row.EmbPtWeight*weight[n])
                    histos[folder+'/h_collmassSpread_lowPhi_pfmet'].Fill(collmass(row, row.type1_pfMetEt, row.type1_pfMetPhi)-125.0, row.EmbPtWeight*weight[n])
                if deltaPhi(row.tPhi, row.mva_metPhi) > 1.57 :  
                    histos[folder+'/h_collmass_highPhi_mvamet'].Fill(collmass(row, row.mva_metEt, row.mva_metPhi), row.EmbPtWeight*weight[n])
                    histos[folder+'/h_collmassSpread_highPhi_mvamet'].Fill(collmass(row, row.mva_metEt, row.mva_metPhi)-125.0, row.EmbPtWeight*weight[n])
                if deltaPhi(row.tPhi, row.mva_metPhi) < 1.57 :  
                    histos[folder+'/h_collmass_lowPhi_mvamet'].Fill(collmass(row, row.mva_metEt, row.mva_metPhi), row.EmbPtWeight*weight[n])
                    histos[folder+'/h_collmassSpread_lowPhi_mvamet'].Fill(collmass(row, row.mva_metEt, row.mva_metPhi)-125.0, row.EmbPtWeight*weight[n])
                histos[folder+'/h_collmassSpread_pfmet'].Fill(collmass(row, row.type1_pfMetEt, row.type1_pfMetPhi)-125.0, row.EmbPtWeight*weight[n])
                histos[folder+'/h_collmassSpread_mvamet'].Fill(collmass(row, row.mva_metEt, row.mva_metPhi)-125.0, row.EmbPtWeight*weight[n])


                histos[folder+'/h_collmass_pfmet'].Fill(collmass(row, row.pfMetEt, row.pfMetPhi), row.EmbPtWeight*weight[n])
                histos[folder+'/h_collmass_mvamet'].Fill(collmass(row, row.mva_metEt, row.mva_metPhi), row.EmbPtWeight*weight[n])
                histos[folder+'/h_collmass_pfmet_Ty1'].Fill(collmass(row, row.type1_pfMetEt, row.type1_pfMetPhi), row.EmbPtWeight*weight[n])
                
                    
                    
                histos[folder+'/h_vismass'].Fill(row.e_t_Mass, row.EmbPtWeight*weight[n])
                
                histos[folder+'/type1_pfMetEt_vs_dPhi'].Fill(deltaPhi(row.tPhi, row.type1_pfMetPhi), row.type1_pfMetEt, row.EmbPtWeight*weight[n])
                histos[folder+'/mvaMetEt_vs_dPhi'].Fill(deltaPhi(row.tPhi, row.mva_metPhi), row.mva_metEt, row.EmbPtWeight*weight[n])
                
                histos[folder+'/ePFMET_DeltaPhi'].Fill(deltaPhi(row.ePhi, row.type1_pfMetPhi), row.EmbPtWeight*weight[n])
                histos[folder+'/ePFMET_DeltaPhi_Ty1'].Fill(deltaPhi(row.ePhi, row.type1_pfMetPhi), row.EmbPtWeight*weight[n])
                histos[folder+'/eMVAMET_DeltaPhi'].Fill(deltaPhi(row.ePhi, row.mva_metPhi), row.EmbPtWeight*weight[n])
                
                histos[folder+'/ePFMET_Mt'].Fill(row.eMtToPFMET, row.EmbPtWeight*weight[n])
                histos[folder+'/ePFMET_Mt_Ty1'].Fill(row.eMtToPfMet_Ty1, row.EmbPtWeight*weight[n])
                histos[folder+'/eMVAMET_Mt'].Fill(row.eMtToMVAMET, row.EmbPtWeight*weight[n])
                
                histos[folder+'/tPFMET_DeltaPhi'].Fill(deltaPhi(row.tPhi, row.pfMetPhi), row.EmbPtWeight*weight[n])
                histos[folder+'/tPFMET_DeltaPhi_Ty1'].Fill(deltaPhi(row.tPhi, row.type1_pfMetPhi), row.EmbPtWeight*weight[n])
                histos[folder+'/tMVAMET_DeltaPhi'].Fill(deltaPhi(row.tPhi, row.mva_metPhi), row.EmbPtWeight*weight[n])
                
                histos[folder+'/tPFMET_Mt'].Fill(row.tMtToPFMET, row.EmbPtWeight*weight[n])
                histos[folder+'/tPFMET_Mt_Ty1'].Fill(row.tMtToPfMet_Ty1, row.EmbPtWeight*weight[n])
                histos[folder+'/tMVAMET_Mt'].Fill(row.tMtToMVAMET, row.EmbPtWeight*weight[n])
                    
                histos[folder+'/jetN_20'].Fill(row.jetVeto20, row.EmbPtWeight*weight[n]) 
                histos[folder+'/jetN_30'].Fill(row.jetVeto30, row.EmbPtWeight*weight[n]) 
                

                if n == 0: # if I'm in the dir starting with os or ss I want also the energy scale uncertainties
                    histos[folder+'/h_collmass_pfmet_jes_plus'].Fill(collmass(row, row.pfMet_jes_Et, row.pfMet_jes_plus_Phi), row.EmbPtWeight*weight[n])
                    histos[folder+'/h_collmass_pfmet_jes_minus'].Fill(collmass(row, row.pfMet_jes_Et, row.pfMet_jes_minus_Phi), row.EmbPtWeight*weight[n])
                    ### add the minus in the ntuple.
                    #histos[folder+'/h_collmass_pfmet_mes_plus'].Fill(collmass(row, row.pfMet_mes_Et, row.pfMet_mes_Phi), row.EmbPtWeight*weight[n])
                    #histos[folder+'/h_collmass_pfmet_tes_plus'].Fill(collmass(row, row.pfMet_tes_Et, row.pfMet_tes_Phi), row.EmbPtWeight*weight[n])
                    #histos[folder+'/h_collmass_pfmet_ees_plus'].Fill(collmass(row, row.pfMet_ees_Et, row.pfMet_ees_Phi), row.EmbPtWeight*weight[n])
                    #histos[folder+'/h_collmass_pfmet_ues_plus'].Fill(collmass(row, row.pfMet_ues_Et, row.pfMet_ues_Phi), row.EmbPtWeight*weight[n])
                    
                    
                    histos[folder+'/ePFMET_Mt_jes_minus'].Fill(row.eMtToPfMet_jes_minus, row.EmbPtWeight*weight[n])
                    histos[folder+'/ePFMET_Mt_jes_plus'].Fill(row.eMtToPfMet_jes_plus,   row.EmbPtWeight*weight[n])
                    
                    histos[folder+'/ePFMET_Mt_mes_minus'].Fill(row.eMtToPfMet_mes_minus,row.EmbPtWeight*weight[n]) 
                    histos[folder+'/ePFMET_Mt_mes_plus'].Fill(row.eMtToPfMet_mes_plus,  row.EmbPtWeight*weight[n]) 
                    
                    histos[folder+'/ePFMET_Mt_ees_minus'].Fill(row.eMtToPfMet_ees_minus,row.EmbPtWeight*weight[n]) 
                    histos[folder+'/ePFMET_Mt_ees_plus'].Fill(row.eMtToPfMet_ees_plus,  row.EmbPtWeight*weight[n]) 
                    
                    histos[folder+'/ePFMET_Mt_tes_minus'].Fill(row.eMtToPfMet_tes_minus,row.EmbPtWeight*weight[n]) 
                    histos[folder+'/ePFMET_Mt_tes_plus'].Fill(row.eMtToPfMet_tes_plus,  row.EmbPtWeight*weight[n]) 
                    
                    histos[folder+'/ePFMET_Mt_ues_minus'].Fill(row.eMtToPfMet_ues_minus,row.EmbPtWeight*weight[n]) 
                    histos[folder+'/ePFMET_Mt_ues_plus'].Fill(row.eMtToPfMet_ues_plus,  row.EmbPtWeight*weight[n]) 
                        
                    histos[folder+'/tPFMET_Mt_jes_plus'].Fill(row.tMtToPfMet_jes_plus,row.EmbPtWeight*weight[n])
                    histos[folder+'/tPFMET_Mt_mes_plus'].Fill(row.tMtToPfMet_mes_plus,row.EmbPtWeight*weight[n])
                    histos[folder+'/tPFMET_Mt_ees_plus'].Fill(row.tMtToPfMet_ees_plus,row.EmbPtWeight*weight[n])
                    histos[folder+'/tPFMET_Mt_tes_plus'].Fill(row.tMtToPfMet_tes_plus,row.EmbPtWeight*weight[n])
                    histos[folder+'/tPFMET_Mt_ues_plus'].Fill(row.tMtToPfMet_ues_plus,row.EmbPtWeight*weight[n])
                    histos[folder+'/tPFMET_Mt_jes_minus'].Fill(row.tMtToPfMet_jes_minus,row.EmbPtWeight*weight[n])
                    histos[folder+'/tPFMET_Mt_mes_minus'].Fill(row.tMtToPfMet_mes_minus,row.EmbPtWeight*weight[n])
                    histos[folder+'/tPFMET_Mt_ees_minus'].Fill(row.tMtToPfMet_ees_minus,row.EmbPtWeight*weight[n])
                    histos[folder+'/tPFMET_Mt_tes_minus'].Fill(row.tMtToPfMet_tes_minus,row.EmbPtWeight*weight[n])
                    histos[folder+'/tPFMET_Mt_ues_minus'].Fill(row.tMtToPfMet_ues_minus,row.EmbPtWeight*weight[n])
